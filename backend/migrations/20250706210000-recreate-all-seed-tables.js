// Comprehensive migration: Drop and recreate all tables used in seeding with all required columns
'use strict';
...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    // Recreate community_leaderboards
    ...
    // Recreate smartload_optimizations
    ...
    // Recreate push_notification_tokens
