// Migration to drop and recreate crisis_events and emergency_hubs tables with correct columns
'use strict';
  ...
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.createTable('emergency_hubs', {
      ...
      crisis_event_id: {
        type: Sequelize.UUID,
        allowNull: false,
        references: { model: 'crisis_events', key: 'crisis_event_id' },
        onDelete: 'CASCADE'
      },
